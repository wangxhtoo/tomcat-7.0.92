...
public interface RequestDispatcher {
	 ...
	 * custom error-handling servlet or JSP page is invoked. The value of the
	 * attribute is of type {@code java.lang.Throwable}. See the chapter "Error
	 ...
	 * The name of the request attribute that should be set by the container when
	 * custom error-handling servlet or JSP page is invoked. The value of the
	 * attribute is of type {@code java.lang.Class}. See the chapter "Error
	 * Handling" in the Servlet Specification for details.
	 *
	 * @since Servlet 3.0
	 */
	 ...
	 * The name of the request attribute that should be set by the container when
	 * custom error-handling servlet or JSP page is invoked. The value of the
	 * attribute is of type {@code java.lang.String}. See the chapter "Error
	 * Handling" in the Servlet Specification for details.
	 *
	 * @since Servlet 3.0
	 */
	 ...
	 * The name of the request attribute that should be set by the container when
	 * custom error-handling servlet or JSP page is invoked. The value of the
	 * attribute is of type {@code java.lang.Integer}. See the chapter "Error
	 * Handling" in the Servlet Specification for details.
	 *
	 * @since Servlet 3.0
	 */
	...
	/**
	 * The name of the request attribute that should be set by the container when
	 * the {@link #forward(ServletRequest, ServletResponse)} method is called. It
	 * provides the original value of a path-related property of the request. See
	 * the chapter "Forwarded Request Parameters" in the Servlet Specification for
	 * details.
	 *
	 * @since Servlet 3.0
	 */
	...
	/**
	 * The name of the request attribute that should be set by the container when
	 * the {@link #include(ServletRequest, ServletResponse)} method is called on the
	 * {@code RequestDispatcher} obtained by a path and not by a name. It provides
	 * information on the path that was used to obtain the {@code RequestDispatcher}
	 * instance for this include call. See the chapter "Included Request Parameters"
	 ...
	 * <code>getRequestDispatcher()</code>, the <code>ServletRequest</code> object
	 * has its path elements and parameters adjusted to match the path of the target
	 * resource.
	 * 
	 * <p>
	 * <code>forward</code> should be called before the response has been committed
	 * to the client (before response body output has been flushed). If the response
	 ...
	 * {@link ServletRequestWrapper} or {@link ServletResponseWrapper} classes that
	 * wrap them.
	 * 
	 * <p>
	 * 将当前Servlet的请求转移到目标Servlet上，主控权在目标Servlet上，当前Servlet的执行终止
	 * 
	 * 
	 ...
	 * response status code or set headers; any attempt to make a change is ignored.
	 * 
	 * <p>
	 * The request and response parameters must be either the same objects as were
	 * passed to the calling servlet's service method or be subclasses of the
	 ...
	 * 
	 * <p>
	 * 将目标Servlet包含到当前Servlet中，主控权在当前Servlet中
	 * 
