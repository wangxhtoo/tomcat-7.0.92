...
public interface Servlet {
	 ...
	 * instantiating the servlet. The <code>init</code> method must complete
	 ...
	 * 
	 * @exception ServletException if an exception has occurred that interferes with
	 ...
	 * startup parameters for this servlet. The <code>ServletConfig</code> object
	 * returned is the one passed to the <code>init</code> method.
	 * 
	 * <p>
	 * Implementations of this interface are responsible for storing the
	 * <code>ServletConfig</code> object so that this method can return it. The
	 * {@link GenericServlet} class, which implements this interface, already does
	 * this.
	 * 
	 ...
	 * 
	 * <p>
	 * This method is only called after the servlet's <code>init()</code> method has
	 ...
	 * connections, and as well as the servlet's class and instance variables. More
	 ...
	 * timeout period has passed. After the servlet container calls this method, it
	 * will not call the <code>service</code> method again on this servlet.
	 * 
	 * <p>
