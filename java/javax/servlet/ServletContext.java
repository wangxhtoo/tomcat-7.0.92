...
public interface ServletContext {
	 ...
	 *                                       method of a
	 *                                       {@link ServletContextListener} that was
	 *                                       not defined in a web.xml file, a
	 *                                       web-fragment.xml file nor annotated
	 *                                       with
	 *                                       {@link javax.servlet.annotation.WebListener}.
	 *                                       For example, a
	 *                                       {@link ServletContextListener} defined
	 *                                       in a TLD would not be able to use this
	 *                                       method.
	 *
	...
	/**
	 * Returns the MIME type of the specified file, or <code>null</code> if the MIME
	 * type is not known. The MIME type is determined by the configuration of the
	 ...
	 * <code>URLConnection</code> objects that are necessary to access the resource.
	 * <p>
	 ...
	 * <code>java.lang.Class.getResource</code>, which looks up resources based on a
	 * class loader. This method does not use class loaders.
	 * 
	 * @param path a <code>String</code> specifying the path to the resource
	 * @return the resource located at the named path, or <code>null</code> if there
	 *         is no resource at that path
	 * @exception MalformedURLException if the pathname is not given in the correct
	 *                                  form
	 */
	 ...
	 * <code>RequestDispatcher</code> for resources in foreign contexts. This method
	 * returns <code>null</code> if the <code>ServletContext</code> cannot return a
	 ...
	 * its name using {@link ServletConfig#getServletName}.
	 * <p>
	 ...
	 *             <code>ServletContext</code>. In this version, this method always
	 ...
	 *             <code>ServletContext</code> class and can perform shared business
	 *             logic by invoking methods on common non-servlet classes.
	 */
	 ...
	 *             <p>
	 *             This method was originally defined to return an
	 *             <code>Enumeration</code> of all the servlet names known to this
	...
	/**
	 * Returns a <code>String</code> containing the real path for a given virtual
	 ...
	 * proper path separators. This method returns <code>null</code> if the servlet
	 * container cannot translate the virtual path to a real path for any reason
	 * (such as when the content is being made available from a <code>.war</code>
	 * archive).
	 * 
	 ...
	 * <code>null</code> if there is no attribute by that name. An attribute allows
	 ...
	 * about its attributes. A list of supported attributes can be retrieved using
	 * <code>getAttributeNames</code>.
	 * <p>
	 * The attribute is returned as a <code>java.lang.Object</code> or some
	 * subclass. Attribute names should follow the same convention as package names.
	 * The Java Servlet API specification reserves names matching
	 ...
	 * name specified is already used for an attribute, this method will replace the
	 * attribute with the new to the new attribute.
	 * <p>
	 * If listeners are configured on the <code>ServletContext</code> the container
	 ...
	 * notifies them accordingly.
	 * 
	 * @param name a <code>String</code> specifying the name of the attribute to be
	 *             removed
	 */
	 ...
	 * 
	 * @return The name of the web application or null if no name has been declared
	 ...
	 *
	 * @return The registration details for the named Servlet or <code>null</code>
