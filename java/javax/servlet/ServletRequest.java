...
public interface ServletRequest {
	 ...
	 * programmatically using {@link ServletRequest#setAttribute}. This allows
	 * information to be embedded into a request before a {@link RequestDispatcher}
	 * call.
	 * <p>
	 ...
	 *         or <code>null</code> if the request does not specify a character
	 *         encoding
	 */
	 ...
	 * type is not known. For HTTP servlets, same as the value of the CGI variable
	 * CONTENT_TYPE.
	 * 
	 ...
	 * {@link ServletInputStream}. Either this method or {@link #getReader} may be
	 * called to read the body, not both.
	 * 
	 * @return a {@link ServletInputStream} object containing the body of the
	 *         request
	 * @exception IllegalStateException if the {@link #getReader} method has already
	 ...
	 * value of the part before ":" in the <code>Host</code> header value, if any,
	 ...
	 * part after ":" in the <code>Host</code> header value, if any, or the server
	 ...
	 *                                  character set encoding used is not supported
	 *                                  and the text cannot be decoded
	 * @exception IllegalStateException if {@link #getInputStream} method has been
	 ...
	 * the request. If the engine cannot or chooses not to resolve the hostname (to
	 ...
	 * It is warned that when the request is dispatched from the servlet resides in
	 * a different web application by <code>RequestDispatcher</code>, the object set
	 * by this method may not be correctly retrieved in the caller servlet.
	 * 
	 * @param name a <code>String</code> specifying the name of the attribute
	...
	/**
	 * Returns the preferred <code>Locale</code> that the client will accept content
	 * in, based on the Accept-Language header. If the client request doesn't
	 * provide an Accept-Language header, this method returns the default locale for
	 * the server.
	 * 
	 ...
	 * header. If the client request doesn't provide an Accept-Language header, this
	 * method returns an <code>Enumeration</code> containing one
	 ...
	 * relative path.
	 * 
	 * @param path a <code>String</code> specifying the pathname to the resource. If
	 ...
	 * 
	 * @return a <code>String</code> containing the host name of the IP on which the
	 *         request was received.
	 * @since 2.4
	 */
	 ...
	 * request was received.
	 * 
	 * @return a <code>String</code> containing the IP address on which the request
	 *         was received.
	 * @since 2.4
	 */
