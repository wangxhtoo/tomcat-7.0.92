...
public class Cookie implements Cloneable, Serializable {
	 ...
	 *                                  characters (for example, a comma, space, or
	 *                                  semicolon) or it is one of the tokens
	 ...
	 *
	 * @return a <code>String</code> containing the comment, or <code>null</code> if
	 *         none
	 * @see #setComment
	 */
	 ...
	 * with a dot (<code>.foo.com</code>) and means that the cookie is visible to
	 * servers in a specified Domain Name System (DNS) zone (for example,
	 * <code>www.foo.com</code>, but not <code>a.b.foo.com</code>). By default,
	 ...
	 *             server only when using a secure protocol; if <code>false</code>,
	 ...
	 * secure protocol, or <code>false</code> if the browser can send cookies using
	 * any protocol.
	 *
	 * @return <code>true</code> if the browser uses a secure protocol; otherwise,
	 *         <code>true</code>
	 * @see #setSecure
	 */
	...
	/**
	 * If set to true, enforce the cookie naming rules in the spec that require no
	 * separators in the cookie name. Default is usually false. If
	...
	/**
	 * Overrides the standard <code>java.lang.Object.clone</code> method to return a
	 * copy of this cookie.
	 */
	@Override
	public Object clone() {
	...
	/**
	 * Sets the flag that controls if this cookie will be hidden from scripts on the
	 * client side.
	 *
	...
	/**
	 * Gets the flag that controls if this cookie will be hidden from scripts on the
	 * client side.
	 *
