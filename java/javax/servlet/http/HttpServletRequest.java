...
public interface HttpServletRequest extends ServletRequest {
	 ...
	 *         string indicating the authentication scheme, or <code>null</code> if
	 ...
	 * @exception IllegalArgumentException If the header value can't be converted to
	 *                                     a date
	 */
	 ...
	 * 
	 * @return a <code>String</code>, decoded by the web container, specifying extra
	 *         path information that comes after the servlet path but before the
	 ...
	 * <code>null</code> or the servlet container cannot translate the virtual path
	 * to a real path for any reason (such as when the web application is executed
	 * from an archive). The web container does not decode this string.
	 * 
	...
	/**
	 * Returns a <code>java.security.Principal</code> object containing the name of
	 * the current authenticated user. If the user has not been authenticated, the
	...
	/**
	 * Returns the current <code>HttpSession</code> associated with this request or,
	...
	/**
	 * Triggers the same authentication process as would be triggered if the request
	 * is for a resource that is protected by a security constraint.
	 *
	 ...
	 *                          {@link #getAuthType()} are non-null, if the
	 *                          configured authenticator does not support user name
	 *                          and password authentication or if the authentication
	 *                          fails
	 * @since Servlet 3.0
	 */
	...
	/**
	 * Gets the named Part or null if the Part does not exist. Triggers upload of
	 * all Parts.
	 * 
	 * @param name
