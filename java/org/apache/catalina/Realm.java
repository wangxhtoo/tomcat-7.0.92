...
public interface Realm {
	...
	/**
	 * Return the Principal associated with the specified username, if there is one;
	 ...
	 * the digest calculated using the given parameters using the method described
	 * in RFC 2069; otherwise return <code>null</code>.
	 *
	 * @param username Username of the Principal to look up
	 ...
	 * @param storeCreds Should the realm attempt to store the delegated credentials
	 *                   in the returned Principal?
	 */
	...
	/**
	 * Return the SecurityConstraints configured to guard the request URI for this
	 * request, or <code>null</code> if there is no such constraint.
	 *
	...
	/**
	 * Enforce any user data constraint required by the security constraint guarding
	 * this request URI. Return <code>true</code> if this constraint was not
	 * violated and processing should continue, or <code>false</code> if we have
