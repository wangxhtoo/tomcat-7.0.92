 ...
 * 
 * 主要作用： </br>
 * 1）提供了监听机制，用于在Tomcat整个生命周期中对不同事件进行处理 </br>
 * 2）提供了Tomcat容器全局的命名资源实现</br>
...
public interface Server extends Lifecycle {
	 ...
	 * {@link #getCatalina()} {@link Catalina#getParentClassLoader()}. If catalina
	 * has not been set, return the system class loader.
	 */
