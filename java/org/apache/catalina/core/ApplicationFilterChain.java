...
final class ApplicationFilterChain implements FilterChain, CometFilterChain {
	...
	private void internalDoFilterEvent(CometEvent event) throws IOException, ServletException {
		...
		if (pos < n) {
			...
			try {
				...
				/*
				 * support.fireInstanceEvent(InstanceEvent.BEFORE_FILTER_EVENT, filter, event);
				 */
				...
				/*
				 * support.fireInstanceEvent(InstanceEvent.AFTER_FILTER_EVENT, filter, event);
				 */
			} catch (IOException e) {
				/*
				 * if (filter != null)
		...
		try {
			/*
			 * support.fireInstanceEvent(InstanceEvent.BEFORE_SERVICE_EVENT, servlet,
			 * request, response);
			 */
			if (Globals.IS_SECURITY_ENABLED) {
				final CometEvent ev = event;
			...
			/*
			 * support.fireInstanceEvent(InstanceEvent.AFTER_SERVICE_EVENT, servlet,
			 * request, response);
			 */
		} catch (IOException e) {
			/*
	...
	/**
	 * Set the InstanceSupport object used for event notifications for this filter
	 * chain.
	 *
