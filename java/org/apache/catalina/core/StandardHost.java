...
public class StandardHost extends ContainerBase implements Host {
	...
	/**
	 * The Java class name of the default Context implementation class for deployed
	 * web applications.
	 */
	...
	/**
	 * The Java class name of the default error reporter implementation class for
	...
	/**
	 * Track the class loaders for the child web applications so memory leaks can be
	 * detected.
	 */
	private Map<ClassLoader, String> childClassLoaders = new WeakHashMap<ClassLoader, String>();

	/**
	 * Any file or directory in {@link #appBase} that this pattern matches will be
	 * ignored by the automatic deployment process (both {@link #deployOnStartup}
	 * and {@link #autoDeploy}).
	 */
	...
	/**
	 * Return the application root for this Host. This can be an absolute pathname,
	...
	/**
	 * Set the application root for this Host. This can be an absolute pathname, a
	...
	/**
	 * Set the Xml root for this Host. This can be an absolute pathname, a relative
	 * pathname, or a URL. If null, defaults to ${catalina.base}/conf/&lt;engine
	 * name&gt;/&lt;host name&gt; directory
	 *
	...
	/**
	 * Returns true if the Host will attempt to create directories for appBase and
	 * xmlBase unless they already exist.
	 */
	@Override
	...
	/**
	 * Set to true if the Host should attempt to create directories for xmlBase and
	 * appBase upon startup
	 * 
	 * @param createDirs
	 */
	@Override
	...
	/**
	 * Return the Java class name of the Context implementation class for new web
	 * applications.
	 */
	...
	/**
	 * Return the value of the deploy on startup flag. If true, it indicates that
	 * this host's child webapps should be discovered and automatically deployed at
	 * startup time.
	 */
	@Override
	...
	/**
	 * Set the canonical, fully qualified, name of the virtual host this Container
	 * represents.
	 *
	...
	/**
	 * Return the regular expression that defines the files and directories in the
	...
	/**
	 * Return the compiled regular expression that defines the files and directories
	 * in the host's {@link #appBase} that will be ignored by the automatic
	 * deployment process.
	 */
	@Override
	...
	/**
	 * Used to ensure the regardless of {@link Context} implementation, a record is
	 * kept of the class loader used every time a context starts.
	 */
	...
	/**
	 * Attempt to identify the contexts that have a class loader memory leak. This
	 * is usually triggered on context reload. Note: This method attempts to force a
	 * full garbage collection. This should be used with extreme caution on a
	 * production system.
	 */
