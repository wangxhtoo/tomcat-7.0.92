...
public class WebappLoader extends LifecycleMBeanBase implements Loader, PropertyChangeListener {
	...
	/**
	 * Construct a new WebappLoader with no defined parent class loader (so that the
	...
	/**
	 * Construct a new WebappLoader with the specified class loader to be defined as
	 * the parent of the ClassLoader we ultimately create.
	 *
	...
	/**
	 * The Java class name of the ClassLoader implementation to be used. This class
	 * should extend WebappClassLoaderBase, otherwise, a different loader
