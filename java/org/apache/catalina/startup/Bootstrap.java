...
public final class Bootstrap {
	...
	/**
	 * 根据名称初始化类加载器</br>
	 * 通过配置文件catalina.properties中的common.loader、server.loader、shared.loader进行创建</br>
	 * 默认情况下server.loader、shared.loader为空，则指定创建的加载器为commonLoader
	 * 
	 * @param name
	 * @param parent
	 * @return
	...
	public void init() throws Exception {
		...
		// 设置成当前线程类加载器，防止后面加载类时加载不成功
		Thread.currentThread().setContextClassLoader(catalinaLoader);
		// 使用catalinaLoader类加载器加载类
		...
		// 调用Catalina的setParentClassLoader方法设置父类加载器
