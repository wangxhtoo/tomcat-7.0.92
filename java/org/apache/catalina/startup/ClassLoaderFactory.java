...
public final class ClassLoaderFactory {
	 ...
	 * org.apache.tomcat.util.buf.UriUtil but that class is not visible until after
	 * the class loaders have been constructed.
	 */
	...
	/**
	 * 资源类型 </br>
	 * DIR：表示整个目录下的资源，包括所有Class、jar包及其他资源</br>
	 * GLOB：表示整个目录下所有的jar包资源，仅仅是.jar后缀的资源</br>
	 * JAR：表示单个jar包资源</br>
	 * URL：表示从URL上获取的jar包资源</br>
	 * 
	 * @author wangxh
	 *
	 */
