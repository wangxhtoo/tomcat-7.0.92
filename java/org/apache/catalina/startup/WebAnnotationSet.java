...
public class WebAnnotationSet {
	...
	protected static void loadApplicationServletAnnotations(Context context) {
		...
		for (Container child : children) {
			if (child instanceof Wrapper) {
				...
				/*
				 * Process RunAs annotation which can be only on servlets. Ref JSR 250,
	...
	protected static void loadClassAnnotation(Context context, Class<?> clazz) {
		 ...
		 * clazz.getAnnotation(EJB.class); if (annotation != null) {
		 * 
		 ...
		 */
		/*
		 * Process WebServiceRef annotation. Ref JSR 224, equivalent to the service-ref
		 * element in the deployment descriptor. The service-ref registration is not
		 * implemented { WebServiceRef annotation = clazz
		 * .getAnnotation(WebServiceRef.class); if (annotation != null) { ContextService
		 ...
		 * 
		 * if (annotation.value() == null) service.setServiceinterface(annotation.type()
		 * .getCanonicalName());
		 * 
		 ...
		 */
		/*
		 * Process DeclareRoles annotation. Ref JSR 250, equivalent to the security-role
	...
	/**
	 * Process a Resource annotation to set up a Resource. Ref JSR 250, equivalent
	 * to the resource-ref, message-destination-ref, env-ref, resource-env-ref or
	 * service-ref element in the deployment descriptor.
	 * 
	 * @param context    The context which will have its annotations processed
	...
	protected static void addResource(Context context, Resource annotation, String defaultName, Class<?> defaultType) {
		...
		if (type.equals("java.lang.String") || type.equals("java.lang.Character") || type.equals("java.lang.Integer")
			...
			/*
			 * General case. Also used for: - javax.resource.cci.InteractionSpec -
