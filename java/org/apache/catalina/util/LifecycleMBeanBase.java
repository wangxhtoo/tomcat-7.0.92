...
public abstract class LifecycleMBeanBase extends LifecycleBase implements MBeanRegistration {
	...
	/**
	 * Sub-classes wishing to perform additional initialization should override this
	 * method, ensuring that super.initInternal() is the first call in the
	 * overriding method.
	 */
	@Override
	...
	/**
	 * Specify the domain under which this component should be registered. Used with
	 * components that cannot (easily) navigate the component hierarchy to determine
	...
	/**
	 * Utility method to enable sub-classes to easily register additional components
	 * that don't implement {@link MBeanRegistration} with an MBean server.<br/>
	 * Note: This method should only be used once {@link #initInternal()} has been
	 * called and before {@link #destroyInternal()} has been called.
	 * 
	...
	/**
	 * Allows the object to be registered with an alternative {@link MBeanServer}
	 * and/or {@link ObjectName}.
	 */
	@Override
