...
public final class JDBCAccessLogValve extends ValveBase implements AccessLog {
	 ...
	 * and port used for the request. Default is <code>true</code>.
	 * 
	...
	/**
	 * Sets the name of the field containing the virtual host information (this is
	 ...
	 *
	 * @param queryField The name of the field containing the URL part of the HTTP
	 *                   query.
	 */
	...
	/**
	 * Sets the logging pattern. The patterns supported correspond to the file-based
	 * "common" and "combined". These are translated into the use of tables
	 * containing either set of fields.
	 * <P>
	 ...
	 *
	 * @param resolveHosts "true" or "false", if host IP resolution is desired or
	 *                     not.
	 */
	 ...
	 * @exception ServletException Database SQLException is wrapped in a
	 *                             ServletException.
	 */
	@Override
