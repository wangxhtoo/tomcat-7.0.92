...
public enum ActionCode {
	...
	/**
	 * Hook called after request, but before recycling. Can be used for logging, to
	 * update counters, custom cleanup - the request is still visible
	 */
	POST_REQUEST,
	...
	/**
	 * Callback for lazy evaluation - extract the SSL-certificate (including forcing
	 * a re-handshake if necessary)
	 */
	REQ_SSL_CERTIFICATE,
