...
public class Http11NioProcessor extends AbstractHttp11Processor<NioChannel> {
	...
	public Http11NioProcessor(int maxHttpHeaderSize, boolean rejectIllegalHeaderName, NioEndpoint endpoint,
		...
		inputBuffer = new InternalNioInputBuffer(request, maxHttpHeaderSize, rejectIllegalHeaderName, httpParser);
