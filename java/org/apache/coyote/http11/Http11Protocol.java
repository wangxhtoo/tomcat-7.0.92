 ...
 * protocols like JNI.
 * 
 * 阻塞式HTTP协议的通信，它包含从套接字连接接收、处理、相应客户端的整个过程。 它主要包含JIoEndpoint和Http11Processor组件。
 *
...
public class Http11Protocol extends AbstractHttp11JsseProtocol<Socket> {
	...
	protected static class Http11ConnectionHandler extends AbstractConnectionHandler<Socket, Http11Processor>
		...
		protected Http11Processor createProcessor() {
			Http11Processor processor = new Http11Processor(proto.getMaxHttpHeaderSize(),
					proto.getRejectIllegalHeaderName(), (JIoEndpoint) proto.endpoint, proto.getMaxTrailerSize(),
