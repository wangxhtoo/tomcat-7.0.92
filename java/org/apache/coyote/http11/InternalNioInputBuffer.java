...
public class InternalNioInputBuffer extends AbstractInputBuffer<NioChannel> {
	 ...
	 */
	public InternalNioInputBuffer(Request request, int headerBufferSize, boolean rejectIllegalHeaderName,
	 ...
	 *                otherwise
	 * @return boolean - true if data was read, false is no data read, EOFException
	 *         if EOF is reached
