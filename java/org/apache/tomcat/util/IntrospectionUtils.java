...
public final class IntrospectionUtils {
	 ...
	 * same value. This value will be the other System property that is set, or the
	 ...
	 * applications. This System property is currently used by Jasper when its JSP
	 * servlet compiles the Java file for a JSP.
	 * 
	 * @deprecated Not used
	 */
	@Deprecated
	...
	/**
	 * Find a method with the right name If found, call the method ( if param is int
	 * or boolean we'll convert value to the right type before) - that means you can
	 * have setDebug(1).
	 */
	...
	/**
	 * Add all the jar files in a dir to the classpath, represented as a Vector of
	 * URLs.
	 * 
	...
	/**
	 * Add elements from the classpath <i>cp </i> to a Vector <i>jars </i> as file
	 * URLs (We use Vector for JDK 1.1 compat).
	 * <p>
	 *
	 * @param jars The jar list
	 * @param cp   a String classpath of directory or jar file elements separated by
	 *             path.separator delimiters.
	...
	/**
	 * Construct a URL classpath from files in a directory, a cpath property, and
	 * tools.jar.
	 * 
	 * @deprecated Not used
	 */
