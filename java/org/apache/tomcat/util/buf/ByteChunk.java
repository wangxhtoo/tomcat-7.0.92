...
public final class ByteChunk extends AbstractChunk {
	...
	/**
	 * Returns the first instance of any byte that is not one of the given bytes in
	 * the byte array between the specified start and end.
	 *
	 * @param bytes The byte array to search
	 * @param start The point to start searching from in the byte array
	 * @param end   The point to stop searching in the byte array
	 * @param b     The list of bytes to search for
	 * @return The position of the first instance a byte that is not in the list of
	 *         bytes to search for or -1 if no such byte is found.
	 * @deprecated Unused. Will be removed in Tomcat 8.0.x onwards.
	 */
	@Deprecated
