...
public class Digester extends DefaultHandler2 {
	...
	/**
	 * Construct a new Digester, allowing a SAXParser to be passed in. This allows
	 * Digester to be used in environments which are unfriendly to JAXP1.1 (such as
	 * WebLogic 6.0). Thanks for the request to change go to James House
	 * (james@interobjective.com). This may help in places where you are able to
	 * load JAXP 1.1 classes yourself.
	 */
	...
	/**
	 * Construct a new Digester, allowing an XMLReader to be passed in. This allows
	 * Digester to be used in environments which are unfriendly to JAXP1.1 (such as
	 * WebLogic 6.0). Note that if you use this option you have to configure
	 * namespace and validation support yourself, as these properties only affect
	 * the SAXParser and empty constructor.
	 */
	...
	/**
	 * Returns a flag indicating whether the requested feature is supported by the
	 ...
	 * <code>XMLReader</code> implementation. See <a
	 * href="http://www.saxproject.org/apidoc/xml/sax/package-summary.html#package-description"
	 * http://www.saxproject.org/apidoc/xml/sax/package-summary.html#package-description</a>
	...
	/**
	 * Parse the content of the specified reader using this Digester. Returns the
	...
	/**
	 * Parse the content of the specified URI using this Digester. Returns the root
	 * element from the object stack (if any).
	 *
	 ...
	 * <code>paramTypes</code> is null or empty, in this case the rule will call the
	 * specified method with no arguments.
	 *
	 * @param pattern    Element matching pattern
	 * @param methodName Method name to be called
	 * @param paramCount Number of expected parameters (or zero for a single
	 *                   parameter from the body of this element)
	 * @param paramTypes Set of Java class names for the types of the expected
	 *                   parameters (if you wish to use a primitive type, specify
	 ...
	 * @param paramCount Number of expected parameters (or zero for a single
	 *                   parameter from the body of this element)
	 * @param paramTypes The Java class names of the arguments (if you wish to use a
	 *                   primitive type, specify the corresponding Java wrapper
	 ...
	 *
	 * @param pattern       Element matching pattern
	 * @param paramIndex    Zero-relative parameter index to set (from the specified
	 *                      attribute)
	...
	/**
	 * Add a "call parameter" rule. This will either take a parameter from the stack
	...
	/**
	 * Add a "call parameter" rule that sets a parameter from the stack. This takes
	 * a parameter from the given position on the stack.
	 *
	 * @param paramIndex The zero-relative parameter number
	 * @param stackIndex set the call parameter to the stackIndex'th object down the
	 ...
	 * object. This can be used to pass constants such as strings to methods; it can
	 * also be used to pass mutable objects, providing ways for objects to do things
	 * like "register" themselves with some shared object.
	 * <p>
	 * Note that when attempting to locate a matching method to invoke, the true
	 * type of the paramObj is used, so that despite the paramObj being passed in
	 * here as type Object, the target method can declare its parameters as being
	 * the true type of the object (or some ancestor type, according to the usual
	...
	/**
	 * Add a "factory create" rule for the specified parameters. Exceptions thrown
	 * during the object creation process will be propagated.
	 *
	 * @param pattern   Element matching pattern
	 ...
	 * @param pattern       Element matching pattern
	 * @param className     Java class name of the object creation factory class
	 * @param attributeName Attribute name which, if present, overrides the value
	 ...
	 *
	 * @param pattern         Element matching pattern
	 * @param creationFactory Previously instantiated ObjectCreationFactory to be
	 *                        utilized
	 * @see FactoryCreateRule
	 */
	 ...
	 *
	 * @param pattern                Element matching pattern
	 * @param className              Java class name of the object creation factory
	 *                               class
	 ...
	 * @param clazz         Default Java class to be created the default Java class
	 *                      name to be created
	 * @see ObjectCreateRule
	 */
	 ...
	 *
	 * <p>
	 * <strong>Note:</strong> a stack is considered empty if no objects have been
	 * pushed onto it yet.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Gets the top object from the stack with the given name. This method does not
	 ...
	 * should take responsibility by checking and setting the {@link #configured}
	 * flag.
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * <strong>Note</strong> This method will be called by {@link #configure} only
	 * when the {@link #configured} flag is false. Subclasses that override
	 * <code>configure</code> or who set <code>configured</code> may find that this
	 ...
	 * and [getCount()-1] is the bottom element. If the specified index is out of
