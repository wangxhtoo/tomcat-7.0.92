...
public class SetNextRule extends Rule {
	 ...
	 * @param digester   The associated Digester
	 * @param methodName Method name of the parent method to call
	 * @param paramType  Java class of the parent method's argument (if you wish to
	 *                   use a primitive type, specify the corresponding Java
	 ...
	 * @deprecated The digester instance is now set in the {@link Digester#addRule}
	 *             method. Use
	 *             {@link #SetNextRule(String methodName,String paramType)} instead.
	 */
	@Deprecated
	 ...
	 * Originally, <code>MethodUtils.invokeExactMethod</code> was used. This matches
	 * methods very strictly and so may not find a matching method when one exists.
	 ...
	 * several methods with correct signatures. So, if you want to choose an exact
