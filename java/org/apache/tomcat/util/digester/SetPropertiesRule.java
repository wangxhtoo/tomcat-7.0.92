...
public class SetPropertiesRule extends Rule {
	 ...
	 *             method. Use {@link #SetPropertiesRule()} instead.
	 */
	@Deprecated
	 ...
	 *
	 * <p>
	 * Two arrays are passed in. One contains the attribute names and the other the
	 * property names. The attribute name / property name pairs are match by
	 * position In order words, the first string in the attribute name list matches
	 ...
	 * <h5>Example One</h5>
	 * <p>
	 * The following constructs a rule that maps the <code>alt-city</code> attribute
	 * to the <code>city</code> property and the <code>alt-state</code> to the
	 * <code>state</code> property. All other attributes are mapped as usual using
	 ...
	 * <h5>Example Two</h5>
	 * <p>
	 * The following constructs a rule that maps the <code>class</code> attribute to
	 * the <code>className</code> property. The attribute <code>ignore-me</code> is
	 * not mapped. All other attributes are mapped as usual using exact name
	 * matching. <code><pre>
	 *      SetPropertiesRule(
	 ...
	 *                   string if the parser is not namespace aware or the element
	 *                   has no namespace
	...
	/**
	 * <p>
	 * Add an additional attribute name to property name mapping. This is intended
	 * to be used from the xml rules.
	 */
