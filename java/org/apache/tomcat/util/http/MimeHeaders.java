...
public class MimeHeaders {
	...
	/**
	 * Returns the Nth header name, or null if there is no such header. This may be
	...
	/**
	 * Returns the Nth header value, or null if there is no such header. This may be
	 * used to iterate through all header fields.
	 */
	...
	/**
	 * Allow "set" operations - return a MessageBytes container for the header value
	 * ( existing header or new if this .
	 */
